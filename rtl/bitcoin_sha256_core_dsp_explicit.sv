...
// Bitcoin fixed-block front end for the explicit-DSP SHA implementation.
module bitcoin_sha256_core_dsp_explicit (
    input wire clk_i, input wire rst_ni, input wire start_i, input wire first_pass_i,
    input wire [255:0] midstate_i, input wire [127:0] header_tail_i,
    input wire [31:0] nonce_i, input wire [255:0] first_digest_i,
    ...
    sha256_core_dsp_explicit u_core (
