 ...
 */
    ...
    #include "xemacps.h" /* defines XEmacPs API */
        ...
        #define XPAR_SCUGIC_0_CPU_BASEADDR     XPAR_SCUGIC_CPU_BASEADDR
    #endif
 ...
 */
    ...
    static inline BaseType_t xVek280EmacIndexFromInstance( const XEmacPs * pxEMAC )
    {
        switch( pxEMAC->Config.BaseAddress )
        {
            case XPAR_XEMACPS_0_BASEADDR:
                return 0;
            #if defined( XPAR_XEMACPS_1_BASEADDR )
                case XPAR_XEMACPS_1_BASEADDR:
                    return 1;
            #endif
            #if defined( XPAR_XEMACPS_2_BASEADDR )
                case XPAR_XEMACPS_2_BASEADDR:
                    return 2;
            #endif
            #if defined( XPAR_XEMACPS_3_BASEADDR )
                case XPAR_XEMACPS_3_BASEADDR:
                    return 3;
            #endif
            default:
                return 0;
    ...
    static inline BaseType_t xVek280EmacIndexFromIf( const xemacpsif_s * pxIf )
    {
        return xVek280EmacIndexFromInstance( &( pxIf->emacps ) );
    }
